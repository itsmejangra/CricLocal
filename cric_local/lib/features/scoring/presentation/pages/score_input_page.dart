...
class _ScoreInputPageState extends State<ScoreInputPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildStartInnings(BuildContext ctx, MatchLoaded state) {
    ...
    return StatefulBuilder(builder: (ctx, setLocal) => SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      const SizedBox(height: 8),
      DropdownButtonFormField<String>(initialValue: strikerId, decoration: const InputDecoration(border: OutlineInputBorder()),
      ...
      const SizedBox(height: 8),
      DropdownButtonFormField<String>(initialValue: nonStrikerId, decoration: const InputDecoration(border: OutlineInputBorder()),
      ...
      const SizedBox(height: 8),
      DropdownButtonFormField<String>(initialValue: bowlerId, decoration: const InputDecoration(border: OutlineInputBorder()),
